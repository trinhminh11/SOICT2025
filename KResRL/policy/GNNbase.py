...
2. **Base Classes**: BlockBase and EdgeIndexBlock - Abstract bases for GNN blocks  
...
class EdgeInfo(torch.nn.Identity):
    ...
    This is typically used within BlockBase for development and debugging
...
class GCNAdjBlock(BlockBase):
    ...
    Inherits all parameters from BlockBase. Additional kwargs are passed
...
class GATBlock(EdgeIndexBlock):
    ...
    Inherits all parameters from BlockBase. Additional GAT-specific parameters:
